...
var decodeTrxCmd = &cobra.Command{
	Use:   "trx <input> [<input>...]",
	Short: "Receives a base64 standard with padding string expecting to contain an sui.checkpoint.v1.CheckpointTransactionBlockResponse object and decodes it",
